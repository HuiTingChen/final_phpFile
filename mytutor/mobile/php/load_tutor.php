...
tbl_tutors.tutor_name, tbl_tutors.tutor_description, tbl_tutors.tutor_datereg, 
GROUP_CONCAT(tbl_subjects.subject_name ORDER BY tbl_subjects.subject_id ASC) FROM tbl_tutors 
INNER JOIN tbl_subjects ON tbl_tutors.tutor_id = tbl_subjects.tutor_id WHERE tbl_tutors.tutor_name 
LIKE '%$search%' OR tbl_subjects.subject_name LIKE '%$search%' GROUP BY tbl_tutors.tutor_id";
